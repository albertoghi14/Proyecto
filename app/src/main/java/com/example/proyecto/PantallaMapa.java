...
public class PantallaMapa extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LocationManager locationManager = (LocationManager) PantallaMapa.this.getSystemService(Context.LOCATION_SERVICE);
        LocationListener locationListener = new LocationListener() {
            //Preguntar por mi ubicacion
            @Override
            public void onLocationChanged(Location location) {
                LatLng miUbicacion = new LatLng(location.getLatitude(), location.getAltitude());
        ...
        LatLng espana = new LatLng(43.37906732930344, -3.217704313166621);
        mMap.addMarker(new MarkerOptions().position(espana).title("I.E.S. Ataulfo Argenta"));
